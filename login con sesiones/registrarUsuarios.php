...
$insertar = "INSERT INTO `registrar_usuarios` (`dni`, `nombre`, `apellidos`, `usuario`, `clave`, `email`, `departamento`, `direccion` ,  `ciudad` , `pais`, `fecha` , `telefono` , `fecha_registro`) VALUES ('$dni', '$nombre','$apellidos','$usuario','$password','$email', '$departamento', '$direccion', '$ciudad', '$pais' , '$fecha', '$telefono', CURRENT_TIMESTAMP)";
